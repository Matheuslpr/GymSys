...
SELECT id, 'Plano Mensal', 120.00 FROM modalidades WHERE nome = 'Musculação';

INSERT INTO planos (modalidade_id, nome, valor_mensal)
SELECT id, 'Plano Trimestral', 300.00 FROM modalidades WHERE nome = 'Musculação';

INSERT INTO planos (modalidade_id, nome, valor_mensal)
SELECT id, 'Plano Mensal', 150.00 FROM modalidades WHERE nome = 'Funcional';

INSERT INTO planos (modalidade_id, nome, valor_mensal)
SELECT id, 'Plano Mensal', 180.00 FROM modalidades WHERE nome = 'Jiu-Jitsu';

INSERT INTO planos (modalidade_id, nome, valor_mensal)
SELECT id, 'Plano Mensal', 160.00 FROM modalidades WHERE nome = 'Muay Thai';

INSERT INTO planos (modalidade_id, nome, valor_mensal)
SELECT id, 'Plano Mensal', 200.00 FROM modalidades WHERE nome = 'Pilates';
